...
This process allows you to leverage OpenAI's powerful models for reasoning and tool selection, while Universal MCP handles the actual execution of the tools and interaction with external services. The [`examples/github.py`](https://github.com/universal-mcp/examples/blob/master/agents/github.py) script provides a practical demonstration of this flow.
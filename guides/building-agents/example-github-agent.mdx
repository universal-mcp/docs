...
This guide demonstrates how to create an AI agent that can perform actions on GitHub, such as starring a repository, using OpenAI's tool-calling feature and Universal MCP tools. This example is based on `examples/github.py`. [1]
...
```
 exmples.xml - examples/github.py
```
...
```
 tools/tools.py - Tool class definition and from_function method
 tools/func_metadata.py - FuncMetadata and ArgModelBase classes
 examples/langraph.py - calculate function example
 utils/docstring_parser.py - parse_docstring function
 tools/adapters.py - ToolFormat and conversion functions
```

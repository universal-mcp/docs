...
```
[1] applications/application.py - BaseApplication.list_tools abstract method
[2] tools/manager.py - ToolManager class
[3] tools/manager.py - ToolManager.register_tools_from_app method
[4] tools/tools.py - Tool.from_function method
[5] tools/manager.py - ToolManager.list_tools method and ToolFormat enum from tools/adapters.py
```
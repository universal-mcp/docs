...
The `app_from_slug` function (found in `universal_mcp.applications.__init__.py`) handles several tasks:
...
```
[1] applications/__init__.py - app_from_slug function and package installation logic
[2] utils/common.py - get_default_class_name, get_default_module_path, get_default_package_name functions
[3] examples/agents/reddit_summary.py, examples/like_tweet.py - get_application function
[4] servers/server.py - LocalServer._load_app and LocalServer._load_apps methods
```
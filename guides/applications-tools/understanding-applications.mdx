...
```
 applications/application.py - BaseApplication class
 applications/application.py - APIApplication class
 applications/application.py - GraphQLApplication class
 applications/README.md - Overview of creating a new application
```
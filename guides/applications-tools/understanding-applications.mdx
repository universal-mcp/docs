...
*   **`BaseApplication`**:
    This is the abstract base class that all applications must inherit from. It defines the common interface, including the essential `list_tools()` method which every application must implement to declare the tools it provides.
...
Refer to [`applications/application.py`](https://github.com/universal-mcp/universal-mcp/blob/master/src/universal_mcp/applications/application.py) for more information.
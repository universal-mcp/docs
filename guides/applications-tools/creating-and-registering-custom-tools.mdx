...
```
 ...
 tools/manager.py - ToolManager.add_tool method, tools/tools.py - Tool.from_function method
 examples/langraph.py - `tool_manager.add_tool(calculate, name="calculate")`
```
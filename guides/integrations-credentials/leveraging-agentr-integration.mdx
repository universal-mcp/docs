...
``` 
[1] integrations/integration.py - AgentRIntegration class
[2] utils/agentr.py - AgentrClient class and its methods
[3] examples/agents/reddit_summary.py - get_application function
[4] servers/server.py - AgentRServer class
```

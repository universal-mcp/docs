...
```
 integrations/integration.py - Integration class, ApiKeyIntegration, AgentRIntegration
 utils/agentr.py - AgentrClient class
 config.py - IntegrationConfig within AppConfig
